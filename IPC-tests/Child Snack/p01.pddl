...
(define (problem prob-snack)
  ...
  (:init
    ...
    (unknown (allergic_gluten child1))
    (unknown (not_allergic_gluten child1))
    (oneof
        (allergic_gluten child1)
        (not_allergic_gluten child1) 
    )

    (unknown (allergic_gluten child2))
    (unknown (not_allergic_gluten child2))
    (oneof
        (allergic_gluten child2)
        (not_allergic_gluten child2) 
    )

    (unknown (allergic_gluten child3))
    (unknown (not_allergic_gluten child3))
    (oneof
        (allergic_gluten child3)
        (not_allergic_gluten child3) 
    )

    (unknown (allergic_gluten child4))
    (unknown (not_allergic_gluten child4))
    (oneof
        (allergic_gluten child4)
        (not_allergic_gluten child4) 
    )

    (unknown (allergic_gluten child5))
    (unknown (not_allergic_gluten child5))
    (oneof
        (allergic_gluten child5)
        (not_allergic_gluten child5) 
    )

    (unknown (allergic_gluten child6))
    (unknown (not_allergic_gluten child6))
    (oneof
