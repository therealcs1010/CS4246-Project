(define (problem grid-y-1)
   ...
   (:init (arm-empty)
          ...
          (oneof   (lock-shape node4-3 square)
          ...
          (oneof   (lock-shape node4-4 square)
	           (lock-shape node4-4 circle)
	           (lock-shape node4-4 diamond)
	           (lock-shape node4-4 triangle))

          (locked node3-4)
          (unknown (lock-shape node3-4 square))
          (unknown (lock-shape node3-4 circle))
          (unknown (lock-shape node3-4 diamond))
          (unknown (lock-shape node3-4 triangle))
          (oneof   (lock-shape node3-4 square)
	           (lock-shape node3-4 circle)
	           (lock-shape node3-4 diamond)
          ...
          (oneof   (lock-shape node3-3 square)
          ...
          (oneof   (lock-shape node2-3 square)
	           (lock-shape node2-3 circle)
	           (lock-shape node2-3 diamond)
	           (lock-shape node2-3 triangle))
          ...
          (oneof   (lock-shape node2-2 square)
          ...
          (oneof   (lock-shape node3-2 square)
          ...
          (oneof   (lock-shape node4-2 square)
