(define (problem grid-y-4)
   ...
   (:init (arm-empty)
          ...
          (locked node7-2)
          (unknown (lock-shape node7-2 square))
          (unknown (lock-shape node7-2 circle))
          (unknown (lock-shape node7-2 diamond))
          (unknown (lock-shape node7-2 triangle))
          (oneof   (lock-shape node7-2 square)
	           (lock-shape node7-2 circle)
	           (lock-shape node7-2 diamond)
	           (lock-shape node7-2 triangle))
          ...
          (oneof   (lock-shape node7-3 square)
          ...
          (oneof   (lock-shape node6-3 square)
          ...
          (oneof   (lock-shape node5-3 square)
          ...
          (oneof   (lock-shape node5-2 square)
	           (lock-shape node5-2 circle)
	           (lock-shape node5-2 diamond)
	           (lock-shape node5-2 triangle))

          (locked node5-1)
          (unknown (lock-shape node5-1 square))
          (unknown (lock-shape node5-1 circle))
          (unknown (lock-shape node5-1 diamond))
          (unknown (lock-shape node5-1 triangle))
          (oneof   (lock-shape node5-1 square)
	           (lock-shape node5-1 circle)
	           (lock-shape node5-1 diamond)
	           (lock-shape node5-1 triangle))

          (locked node6-1)
          (unknown (lock-shape node6-1 square))
          (unknown (lock-shape node6-1 circle))
          (unknown (lock-shape node6-1 diamond))
          (unknown (lock-shape node6-1 triangle))
          (oneof   (lock-shape node6-1 square)
	           (lock-shape node6-1 circle)
	           (lock-shape node6-1 diamond)
	           (lock-shape node6-1 triangle))

          (locked node7-1)
          (unknown (lock-shape node7-1 square))
          (unknown (lock-shape node7-1 circle))
          (unknown (lock-shape node7-1 diamond))
          (unknown (lock-shape node7-1 triangle))
          (oneof   (lock-shape node7-1 square)
	           (lock-shape node7-1 circle)
	           (lock-shape node7-1 diamond)
	           (lock-shape node7-1 triangle))
