(define (problem grid-y-3)
   ...
   (:init (arm-empty)
          ...
          (oneof   (lock-shape node5-3 triangle)
          ...
          (oneof   (lock-shape node5-4 triangle)
	           (lock-shape node5-4 circle)
	           (lock-shape node5-4 diamond)
	           (lock-shape node5-4 square))

          (locked node4-4)
          (unknown (lock-shape node4-4 triangle))
          (unknown (lock-shape node4-4 circle))
          (unknown (lock-shape node4-4 diamond))
          (unknown (lock-shape node4-4 square))
          (oneof   (lock-shape node4-4 triangle)
	           (lock-shape node4-4 circle)
	           (lock-shape node4-4 diamond)
	           (lock-shape node4-4 square))

          (locked node4-3)
          (unknown (lock-shape node4-3 triangle))
          (unknown (lock-shape node4-3 circle))
          (unknown (lock-shape node4-3 diamond))
          (unknown (lock-shape node4-3 square))
          (oneof   (lock-shape node4-3 triangle)
	           (lock-shape node4-3 circle)
	           (lock-shape node4-3 diamond)
	           (lock-shape node4-3 square))

          (locked node3-3)
          (unknown (lock-shape node3-3 triangle))
          (unknown (lock-shape node3-3 circle))
          (unknown (lock-shape node3-3 diamond))
          (unknown (lock-shape node3-3 square))
          (oneof   (lock-shape node3-3 triangle)
	           (lock-shape node3-3 circle)
	           (lock-shape node3-3 diamond)
	           (lock-shape node3-3 square))

          (locked node2-3)
          (unknown (lock-shape node2-3 triangle))
          (unknown (lock-shape node2-3 circle))
          (unknown (lock-shape node2-3 diamond))
          (unknown (lock-shape node2-3 square))
          (oneof   (lock-shape node2-3 triangle)
          ...
          (oneof   (lock-shape node2-2 triangle)
          ...
          (oneof   (lock-shape node3-2 triangle)
	           (lock-shape node3-2 circle)
	           (lock-shape node3-2 diamond)
	           (lock-shape node3-2 square))

          (locked node4-2)
          (unknown (lock-shape node4-2 triangle))
          (unknown (lock-shape node4-2 circle))
          (unknown (lock-shape node4-2 diamond))
          (unknown (lock-shape node4-2 square))
          (oneof   (lock-shape node4-2 triangle)
	           (lock-shape node4-2 circle)
          ...
          (oneof   (lock-shape node5-2 triangle)
